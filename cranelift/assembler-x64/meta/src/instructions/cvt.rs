...
use crate::dsl::{align, fmt, inst, low32, low64, r, rex, vex, w};
...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        inst("cvtss2sd", fmt("A", [w(low64(xmm1)), r(xmm_m32)]), rex([0xF3, 0x0F, 0x5A]).r(), _64b | compat | sse2),
        ...
        inst("cvtsd2ss", fmt("A", [w(low32(xmm1)), r(xmm_m64)]), rex([0xF2, 0x0F, 0x5A]).r(), _64b | compat | sse2),
        ...
        inst("cvtsi2ssl", fmt("A", [w(low32(xmm1)), r(rm32)]), rex([0xF3, 0x0F, 0x2A]).r(), _64b | compat | sse),
        inst("cvtsi2ssq", fmt("A", [w(low32(xmm1)), r(rm64)]), rex([0xF3, 0x0F, 0x2A]).w().r(), _64b | sse),
        inst("cvtsi2sdl", fmt("A", [w(low64(xmm1)), r(rm32)]), rex([0xF2, 0x0F, 0x2A]).r(), _64b | compat | sse2),
        inst("cvtsi2sdq", fmt("A", [w(low64(xmm1)), r(rm64)]), rex([0xF2, 0x0F, 0x2A]).w().r(), _64b | sse2),
        ...
        inst("vcvtsi2ssl", fmt("B", [w(low32(xmm1)), r(xmm2), r(rm32)]), vex(LIG)._f3()._0f().w0().op(0x2A).r(), _64b | compat | avx),
        inst("vcvtsi2ssq", fmt("B", [w(low32(xmm1)), r(xmm2), r(rm64)]), vex(LIG)._f3()._0f().w1().op(0x2A).r(), _64b | avx),
        inst("vcvtsi2sdl", fmt("B", [w(low64(xmm1)), r(xmm2), r(rm32)]), vex(LIG)._f2()._0f().w0().op(0x2A).r(), _64b | compat | avx),
        inst("vcvtsi2sdq", fmt("B", [w(low64(xmm1)), r(xmm2), r(rm64)]), vex(LIG)._f2()._0f().w1().op(0x2A).r(), _64b | avx),
