...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        inst("cvttss2si", fmt("AQ", [w(r32), r(xmm_m32)]), rex([0xF3, 0x0F, 0x2C]).w().r(), _64b | sse),
        ...
        inst("cvtsd2ss", fmt("A", [w(xmm), r(xmm_m64)]), rex([0xF2, 0x0F, 0x5A]).r(), _64b | compat | sse2),
        ...
        inst("cvttsd2si", fmt("A", [w(r32), r(xmm_m64)]), rex([0xF2, 0x0F, 0x2D]).r(), _64b | compat | sse2),
        inst("cvttsd2si", fmt("AQ", [w(r64), r(xmm_m64)]), rex([0xF2, 0x0F, 0x2D]).w().r(), _64b | sse2),
        ...
        inst("cvtsi2ss", fmt("A", [rw(xmm), r(rm32)]), rex([0xF3, 0x0F, 0x2A]).r(), _64b | compat | sse),
        inst("cvtsi2ss", fmt("AQ", [rw(xmm), r(rm64)]), rex([0xF3, 0x0F, 0x2A]).w().r(), _64b | sse),
        inst("cvtsi2sd", fmt("A", [rw(xmm), r(rm32)]), rex([0xF2, 0x0F, 0x2A]).r(), _64b | compat | sse2),
        inst("cvtsi2sd", fmt("AQ", [rw(xmm), r(rm64)]), rex([0xF2, 0x0F, 0x2A]).w().r(), _64b | sse2),
    ]
}
