...
pub struct Memory {
    ...
    allocation: Box<dyn RuntimeLinearMemory>,
...
impl Memory {
    ...
    pub unsafe fn grow(
        ...
        match self.allocation.grow_to(new_byte_size) {
    ...
    pub fn is_static(&mut self) -> bool {
        let as_any = self.allocation.as_any_mut();
